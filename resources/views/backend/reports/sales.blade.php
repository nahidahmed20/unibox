        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <div class="page-subtitle">
                    Monitor sales performance and payment history
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                        ...
                        <form method="GET" class="d-flex justify-content-lg-end gap-2 flex-wrap">
                            ...
                            <button class="btn btn-dark btn-filter px-4">
                                Filter
                            </button>
