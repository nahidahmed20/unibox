...
<div class="app-content-header mb-4 mt-3">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h3 class="mb-0 fw-bold" style="color:#212b36;">Return Orders</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end mb-0 bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item active fw-bold text-dark">Return Order List</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    $(function () {
        let table = $('#orderTable').DataTable({
            ...
            columns: [
                ...
                { data: 'order_date' },
                { data: 'total_amount' },
                { data: 'return_charge', className: 'text-danger fw-bold' }, 
        ...
        $(document).on('click', '.btn-show', function () {
            ...
            $.get("{{ url('admin/orders') }}/" + id, function (html) {
                ...
                let myModal = new bootstrap.Modal(document.getElementById('showOrderModal'));
                myModal.show();
            });
        });
