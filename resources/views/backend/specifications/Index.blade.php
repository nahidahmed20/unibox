...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card modern-card">
                ...
                <div class="modern-card-header">
                    ...
                    <button class="btn btn-dark rounded-pill px-4 fw-bold shadow-sm" id="addSpecificationBtn">
                ...
                <div class="card-body p-0">
                    <div class="p-4">
                        <table id="specificationTable" class="table table-modern table-hover w-100">
                            <thead>
                                <tr>
                                    <th>#</th>
    ...
    <!-- Modal -->
    <div class="modal fade" id="specificationModal">
            ...
            <div class="modal-content">
                <form id="specificationForm">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <label>Specification Name (e.g. Thickness)</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addSpecificationBtn').click(function() {
                ...
                $('#modalTitle').text('Add Specification');
                $('#specificationModal').modal('show');
            });

            $(document).on('click', '.btn-edit', function() {
                let id = $(this).data('id');
                $.get(`/admin/specifications/${id}/edit`, function(data) {
                    $('#specification_id').val(data.id);
                    $('#name').val(data.name);
                    $('#status').val(data.status);
                    $('#modalTitle').text('Edit Specification');
                    $('#specificationModal').modal('show');
                });
            });
            ...
            $('#specificationForm').submit(function(e) {
                ...
                let url = id ? `/admin/specifications/${id}` : "{{ route('specifications.store') }}";
                let formData = { 
                    name: $('#name').val(), 
                    status: $('#status').val(),
                    _token: "{{ csrf_token() }}"
