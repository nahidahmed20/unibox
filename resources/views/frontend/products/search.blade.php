                            ...
                            <div class="row gy-4">
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            ...
                                            <img src="{{ asset('frontend/assets/img/shop/shop-1.png') }}" alt="shop">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-2.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-3.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-7.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Legendary Whitetails Men's.</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-8.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-9.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Govicta Men's Shoes Leather</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-10.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">City Tech Polo Shirt</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-11.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Hygge Fleece Pullover Hoodie</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-12.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Jacket With Logo In Brown</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-13.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Marshall Premium Ferret Diet</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-14.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <div class="overlay"></div>
                                            <img src="{{ asset('frontend/assets/img/shop/shop-15.png') }}" alt="shop">
                                            <span class="sale">New</span>
                                            <ul class="shop-list">
                                                <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                                <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                                        ...
                                        <div class="shop-content">
                                            <span class="category">Levi’s Cotton</span>
                                            <h3 class="title"><a href="shop-details.html">Mink Fur Coat Trendy</a></h3>
                                            <div class="review-wrap">
                                                <ul class="review">
                                                    <li><i class="fa-solid fa-star"></i></li>
                                                    <li><i class="fa-solid fa-star"></i></li>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="grid-shop-items">
                                ...
                                <div class="shop-item grid-shop">
                                    <div class="shop-thumb">
                                        <div class="overlay"></div>
                                        <img src="{{ asset('frontend/assets/img/shop/shop-4.png') }}" alt="shop">
                                        <span class="sale">New</span>
                                        <ul class="shop-list">
                                            <li><a href="#"><i class="fa-regular fa-cart-shopping"></i></a></li>
                                            <li><a href="#"><i class="fa-light fa-heart"></i></a></li>
                ...
                <div class="shop-sidebar sticky-widget">
                    ...
                    <div class="sidebar-items">
                        <div class="sidebar-item">
                            <div class="item-img">
                                <img src="{{ asset('frontend/assets/img/shop/sidebar-img-1.png') }}" alt="img">
                            </div>
                            <div class="content">
                                <ul class="review">
                                    <li><i class="fa-solid fa-star"></i></li>
                        ...
                        <div class="sidebar-item">
                            <div class="item-img">
                                <img src="{{ asset('frontend/assets/img/shop/sidebar-img-2.png') }}" alt="img">
                            </div>
                            <div class="content">
                                <ul class="review">
                                    <li><i class="fa-solid fa-star"></i></li>
                        ...
                        <div class="sidebar-item">
                            <div class="item-img">
                                <img src="{{ asset('frontend/assets/img/shop/sidebar-img-3.png') }}" alt="img">
                            </div>
                            <div class="content">
                                <ul class="review">
                                    <li><i class="fa-solid fa-star"></i></li>
